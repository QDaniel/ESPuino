...
#define DREHENCODER_BUTTON               4          // Button 4: is used to switch ESPuino on and off

// Control-buttons
#define NEXT_BUTTON                    199          // Button 1: GPIO to detect next
#define PREVIOUS_BUTTON                198          // Button 2: GPIO to detect previous (Important: as of 19.11.2020 changed from 33 to 2; make sure to change in SD-MMC-mode)
#define PAUSEPLAY_BUTTON                36          // Button 3: GPIO to detect pause/play
