...
#define DREHENCODER_BUTTON              36          // Button 4: is used to switch ESPuino on and off; 36 = 'VP'

// Control-buttons
#define NEXT_BUTTON                      0          // Button 1: GPIO to detect next
#define PREVIOUS_BUTTON                  2          // Button 2: GPIO to detect previous (Important: as of 19.11.2020 changed from 33 to 2; make sure to change in SD-MMC-mode)
#define PAUSEPLAY_BUTTON                32          // Button 3: GPIO to detect pause/play
#define BUTTON_5                        99          // Button 5
#define BUTTON_6                        99          // Button 6
