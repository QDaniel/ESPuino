...
#define DREHENCODER_BUTTON              32          // Button 4: is used to switch ESPuino on and off

// Control-buttons
#define NEXT_BUTTON                      4          // Button 1: GPIO to detect next
...
#define PAUSEPLAY_BUTTON                 0          // Button 3: GPIO to detect pause/play
